    ...
    <div class="table">
            <div class="crumbs">
                <el-breadcrumb separator="/">
                    <el-breadcrumb-item><i class="el-icon-lx-cascades"></i>全服邮件</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
            <div class="container">
            ...
            <!-- 添加框 -->
            <el-dialog title="添加" :visible.sync="addPlatformEmailVisible" width="900px" center :modal="false"  :close-on-click-modal="false">
                <div class="form-box">
