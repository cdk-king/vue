    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="searchKey.role_describe" placeholder="筛选角色" class="handle-input " style="width:150px"></el-input>
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作"  align="center" v-if="handleVisible">
                    <template slot-scope="scope">
                        <el-button type="text" icon="el-icon-edit" @click="handleManageRight(scope.$index, scope.row)">管理权限</el-button>
        ...
        <!-- 权限选择弹出框 -->
        <el-dialog title="权限管理" :visible.sync="ManageRightVisible" width="50%" height="50%" style="top:-100px">
